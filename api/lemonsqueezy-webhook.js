...
export default async function handler(
    ...
    try {
        ...
        if (payload.data) console.log("Payload data keys:", Object.keys(payload.data))
        if (payload.meta) console.log("Payload meta keys:", Object.keys(payload.meta))
        ...
        } else if (payload.meta?.custom_data?.email) {
