    ...
    <div class="mx-auto max-w-5xl">
      <div class="text-center">
        <h2 class="text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl">
          A different way of reflecting
        </h2>
      </div>

      <div class="mt-16 grid grid-cols-1 gap-12 lg:grid-cols-2">
        <!-- Traditional -->
        <div class="rounded-2xl border border-slate-100 p-10 bg-white">
          <h3 class="text-xl font-semibold text-slate-400">Traditional reflection</h3>
          <ul class="mt-8 space-y-6">
            <li class="flex items-start gap-4">
              <div class="mt-1.5 h-1.5 w-1.5 flex-none rounded-full bg-slate-300"></div>
        ...
        <!-- MindWorks -->
        <div class="rounded-2xl border border-slate-900 p-10 bg-slate-900">
          <h3 class="text-xl font-semibold text-white">MindWorks</h3>
          <ul class="mt-8 space-y-6">
            <li class="flex items-start gap-4">
              <div class="mt-1.5 h-1.5 w-1.5 flex-none rounded-full bg-white"></div>
