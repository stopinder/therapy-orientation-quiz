    ...
    <div class="mx-auto max-w-4xl">
      ...
      <section class="mb-10 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <p class="mt-4 text-base leading-7 text-slate-600">
          Add your Week 1 audio file later. For now, this section holds the
      ...
      <section class="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <p class="mt-4 text-base leading-7 text-slate-600">
          Describe one moment where you left an intention, task, or direction
          without clearly deciding to. The response will reflect patterns back
        ...
        <textarea
            ...
            placeholder="Describe what happened before continuity disappeared..."
        />
...
const exercises = [
  {
    ...
    description:
        "Once today, notice the moment you move away from what you intended to stay with. Do not correct it immediately. Simply notice the departure."
  },
  {
    title: "Track the substitute activity",
    description:
        "Observe what replaces the original intention. It may be preparation, checking, tidying, scrolling, explaining, planning, or another useful-looking action."
  },
  {
    title: "Name the sequence",
    description:
        "At the end of the day, write the sequence plainly: I intended to do this. Then this happened. Then I found myself doing this instead."
  }
]
...
const submitReflection = async () => {
  ...
  try {
    const result = await fetch("/api/courseReflection", {
      method: "POST",
      headers: {
